...
import {useQueryCargos} from "../../pages/Cargos/data/useQueryCargos/useQueryCargos";
import TemplateDesktop from "../../pages/Template/TemplateDesktop";
import {disableExperimentalFragmentVariables} from "@apollo/react-hooks";
...
export default function DTable(props) {
    ...
    const editClickHandle = (data) => {
        const entityId = data.currentTarget.getAttribute('data-id');
        window.location.href = '/cargos/' + entityId;
    }
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">{status(row.status.icon)}</TableCell>
                                        ...
                                        <TableCell align="center">{translate(JSON.parse(row.exportMethod.title))} / {translate(JSON.parse(row.cargoType.title))}</TableCell>
                                        ...
                                        <TableCell align="center">
                                            ...
                                            <div data-id={row.id} onClick={editClickHandle}>
