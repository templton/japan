...
// import {voyageStatusList, portList, shipList, exportMethodList, cargoTypeList, fieldTypeList} from "../../initialData";
// import {cargoTitleTable, clientsTable, voyagesTable, cargoesTable, filesTable} from "../../initialData";
...
import {ExcelImportDlg} from "../CargosLoader/ExcelImportDlg";
...
const headCells = [
    ...
    {id: 'auction', numeric: false, disablePadding: true, label: 'Photos'},
    ...
    {id: 'voyage', numeric: true, disablePadding: true, label: 'Places'},
                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">{status(row.id)}</TableCell>
                                        <TableCell align="center">{111}</TableCell>
                                        <TableCell align="center">{row.fields[0].fieldType.value}</TableCell>
                                        <TableCell align="center">{row.auction.title}({row.auction.id})</TableCell>
                                        <TableCell align="center">{row.exportMethod.title.en} {row.cargoType.title.en}</TableCell>
                                        <TableCell align="center"><Typography variant="body2">{row.sender.title}</Typography></TableCell>
                                        <TableCell align="center"><Typography variant="body2">{row.receiver.title}</Typography></TableCell>
                                        <TableCell align="center">{row.voyage ? row.voyage.title : '-'}</TableCell>
